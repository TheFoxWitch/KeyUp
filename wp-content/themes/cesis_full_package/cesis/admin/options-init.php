<?php
    ...
    if (strpos($url,'staging') !== false || strpos($url,'temp.') !== false || strpos($url,'dev.') !== false || strpos($url,'www2') !== false || strpos($url,'development.') !== false) {
    ...
    $args = array(
        ...
        'save_defaults' => true,
        'update_notice' => TRUE,
        'google_api_key' => 'AIzaSyC1sqls3UV7MR4PQucnXXgl8aMky3r1_4Q',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
			...
			array(
					    ...
					    'type'     => 'image_select',
					    'title'    => __('Select the Sinle Post layout', 'cesis'),
					    'subtitle' => __('Select main content and sidebar alignment.', 'cesis'),
					    'options'  => array(
					        'no_sidebar'      => array(
				            'alt'   => '1 Column',
