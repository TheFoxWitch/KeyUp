 ...
 */
 ...
 $read_more = $cesis_data['cesis_blog_archive_read_more'];
 $read_more_style = $cesis_data['cesis_blog_archive_read_more_style'];
 $read_more_button_style = $cesis_data['cesis_blog_archive_read_more_button_style'];
 $rm_t_font = $cesis_data['cesis_blog_archive_rm_t_font'];
 $rm_t_f_weight = $cesis_data['cesis_blog_archive_rm_t_f_weight'];
 $rm_t_t_transform = $cesis_data['cesis_blog_archive_rm_t_t_transform'];
 $rm_t_l_spacing = $cesis_data['cesis_blog_archive_rm_t_l_spacing'];
 $rm_font = $cesis_data['cesis_blog_archive_rm_font'];
 $rm_f_size = $cesis_data['cesis_blog_archive_rm_f_size'];
 $rm_f_weight = $cesis_data['cesis_blog_archive_rm_f_weight'];
 $rm_t_transform = $cesis_data['cesis_blog_archive_rm_t_transform'];
 $rm_l_spacing = $cesis_data['cesis_blog_archive_rm_l_spacing'];
 $rm_b_size = $cesis_data['cesis_blog_archive_rm_b_size'];
 $rm_b_radius = $cesis_data['cesis_blog_archive_rm_b_radius'];
 $rm_b_shape = $cesis_data['cesis_blog_archive_rm_shape'];
 $rm_t_color = $cesis_data['cesis_blog_archive_rm_t_color'];
 $rm_bg_color = $cesis_data['cesis_blog_archive_rm_bg_color'];
 $rm_b_color = $cesis_data['cesis_blog_archive_rm_b_color'];
 $rm_ht_color = $cesis_data['cesis_blog_archive_rm_ht_color'];
 $rm_hbg_color = $cesis_data['cesis_blog_archive_rm_hbg_color'];
 $rm_hb_color = $cesis_data['cesis_blog_archive_rm_hb_color'];
 ...
 $animation = $cesis_data['cesis_blog_archive_animation'];

$h_f_size = $cesis_data["cesis_blog_archive_heading_font"]['font-size'];
$h_l_spacing = $cesis_data["cesis_blog_archive_heading_font"]['letter-spacing'];
$h_l_height = $cesis_data["cesis_blog_archive_heading_font"]['line-height'];
$h_t_transform = $cesis_data["cesis_blog_archive_heading_font"]['text-transform'];
$h_f_family = $cesis_data["cesis_blog_archive_heading_font"]['font-family'];
$h_f_weight = $cesis_data["cesis_blog_archive_heading_font"]['font-weight'];
 	...
 	$rm_class = $read_more_button_style.' '.$rm_b_size.' '.$rm_b_shape.' ';
            ...
            if($thumb !== ''){
              ...
              $img_url = '';
  					...
  					$tag_list = get_the_terms(get_the_ID(), 'post_tag');
            ...
            $additional_classes = array(
              ...
              $item_cat,
  				...
  				?>
  						<div <?php post_class( $additional_classes ); ?>  style="padding:<?php echo esc_attr($new_padding) ?>px;">
                  ...
                  if($img_url !== ''){?>
                    ...
                    <div class="cesis_blog_m_content">
                      		...
                      		<h2 class="cesis_blog_m_title" style="<?php echo esc_attr($h_styles)?>"><a href="<?php echo esc_url($link) ?>" target="<?php echo esc_attr($target) ?>"><?php echo the_title(); ?></a></h2>
                   ...
                   if($i_author == 'yes' || $i_date == 'yes' || $i_category == 'yes' || $i_tag == 'yes' || $i_comment == 'yes' || $i_like == 'yes' ){ ?>
  							...
  							echo '<div class="cesis_quote_ctn"><span class="cesis_quote_text">'.$quote_text.'</span><span>'.$quote_author.'</span></div>';
  						}elseif( $post_format == 'link'){
  							echo '<div class="cesis_link_ctn"><a href="'.$link.'" target="'.$target.'"><span class="cesis_link_text">'.$link.'</span></a></div>';
  						}
                      		?>
                      		</div>
  						<?php } //start on image style
                      		...
                      		<h2 class="cesis_blog_m_title title_filter"  style="<?php echo esc_attr($h_styles)?>"><a href="<?php echo esc_url($link) ?>" target="<?php echo esc_attr($target) ?>"><?php echo the_title(); ?></a></h2>
